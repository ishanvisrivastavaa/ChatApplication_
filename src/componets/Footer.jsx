      ...
      <div className="w-11/12 mx-auto h-full bg-gray-100 gap-3 px-3 py-5 flex justify-center items-start">
        <div className="col flex-1">
          ...
          <p className="text-sm text-gray-500 italic py-3">
            ...
            ipsum qui veniam deleniti rerum, dolore maiores obcaecati possimus
            dolores quas atque blanditiis architecto! Officiis temporibus
            exercitationem odio. Sequi, ullam quos?
          </p>
        </div>
        <div className="col flex-1">
